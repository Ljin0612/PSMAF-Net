#!/usr/bin/env python3
"""Evaluate a PSMAF-YOLOv8 checkpoint on an M3FD split."""
...
from detection.models.psmaf_yolov8 import PSMAFYOLOv8
from detection.scripts.psmaf_yolo_utils import limit_dataset, save_metrics
from detection.scripts.psmaf_yolov8_utils import evaluate_yolov8
